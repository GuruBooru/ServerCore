...
class S_CHAT final :
 ...
 public:
  ...
  // uint64 chatter_id = 1;
  void clear_chatter_id();
  uint64_t chatter_id() const;
  void set_chatter_id(uint64_t value);
  private:
  uint64_t _internal_chatter_id() const;
  void _internal_set_chatter_id(uint64_t value);
  public:
...
// uint64 chatter_id = 1;
inline void S_CHAT::clear_chatter_id() {
  chatter_id_ = uint64_t{0u};
}
inline uint64_t S_CHAT::_internal_chatter_id() const {
  return chatter_id_;
}
inline uint64_t S_CHAT::chatter_id() const {
  // @@protoc_insertion_point(field_get:Protocol.S_CHAT.chatter_id)
  return _internal_chatter_id();
}
inline void S_CHAT::_internal_set_chatter_id(uint64_t value) {
  
  chatter_id_ = value;
}
inline void S_CHAT::set_chatter_id(uint64_t value) {
  _internal_set_chatter_id(value);
  // @@protoc_insertion_point(field_set:Protocol.S_CHAT.chatter_id)
}
