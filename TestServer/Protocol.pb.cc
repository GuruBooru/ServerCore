...
const uint32_t TableStruct_Protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::C_ENTER_GAME, player_index_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_CHAT, chatter_id_),
...
const ::_pbi::DescriptorTable descriptor_table_Protocol_2eproto = {
    false, false, 271, descriptor_table_protodef_Protocol_2eproto,
    "Protocol.proto",
...
uint8_t* C_ENTER_GAME::_InternalSerialize(
  ...
  if (this->_internal_player_index() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(1, this->_internal_player_index(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Protocol.C_ENTER_GAME)
  ...
  // uint64 player_index = 1;
  if (this->_internal_player_index() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_player_index());
  }
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          chatter_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* S_CHAT::_InternalSerialize(
  ...
  // uint64 chatter_id = 1;
  if (this->_internal_chatter_id() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(1, this->_internal_chatter_id(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Protocol.S_CHAT)
  ...
  // uint64 chatter_id = 1;
  if (this->_internal_chatter_id() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_chatter_id());
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Protocol.S_CHAT)
  ...
  if (from._internal_chatter_id() != 0) {
    _internal_set_chatter_id(from._internal_chatter_id());
  }
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void S_CHAT::InternalSwap(S_CHAT* other) {
  ...
  swap(chatter_id_, other->chatter_id_);
}
